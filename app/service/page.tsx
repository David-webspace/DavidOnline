      ...
      <section className="bg-blue-600 text-white py-12 md:mt-0 mt-6 px-4">
        <div className="max-w-6xl mx-auto">
          <nav className="mb-4 text-sm text-blue-100">
            <Link href="/" className="hover:underline">首頁</Link> <span className="mx-2">&gt;</span> <span className="font-semibold">提供服務</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold tracking-wide mb-2">提供服務</h1>
        </div>
      </section>
